...
@synthesize page;
@synthesize deletable,notRearrangable;
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [ButtonDelete setImage:[UIImage imageNamed:@"closeButton"] forState:UIControlStateNormal];
        [ButtonDelete setImage:[UIImage imageNamed:@"closeButton"] forState:UIControlStateHighlighted];
...
-(void) handleLongPress:(UILongPressGestureRecognizer *)recognizer  {
    ...
    if(self.delegate && [self.delegate respondsToSelector:@selector(gridViewCell:handleLongPress:)] && !notRearrangable)
    {
...
- (void)layoutSubviews
{
    ...
    [ButtonDelete setFrame:CGRectMake(-2 , -2, 22, 22)];
}
